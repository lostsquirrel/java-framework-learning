...
import demo.cxf.hello.server.HelloWorld;
import demo.cxf.hello.server.User;
import demo.cxf.hello.server.UserImpl;

public final class Client {

    private static final QName SERVICE_NAME 
        = new QName("http://server.hello.cxf.demo/", "HelloWorld");
    private static final QName PORT_NAME 
        = new QName("http://server.hello.cxf.demo/", "HelloWorldPort");
    ...
    public static void main(String args[]) throws Exception {
        ...
        // Endpoint Address
        String endpointAddress = "http://localhost:8080/cxf-demo/services/hello_world";
